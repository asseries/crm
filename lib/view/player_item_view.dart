...
class PlayerItemView extends StatefulWidget {
  ...
  @override
  State<PlayerItemView> createState() => _PlayerItemViewState();
}

class _PlayerItemViewState extends State<PlayerItemView> {
  @override
